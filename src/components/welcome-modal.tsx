...
export default function WelcomeModal({ trigger }: WelcomeModalProps) {
  ...
  const defaultTrigger = (
    ...
    >
      <span className="sr-only">About Varesh</span>
    </Button>
  );
            ...
            <DialogHeader className="relative flex flex-row items-start justify-between px-8 pt-8 pb-6">
              <div>
                <DialogTitle className="flex items-center gap-2 text-4xl font-bold tracking-tight">
                  Welcome to {varesh.shortName}&apos;s AI Portfolio
                </DialogTitle>
              ...
              <section className="bg-accent w-full space-y-8 rounded-2xl p-8">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-accent-foreground text-base leading-relaxed">
                    This is an interactive portfolio built to answer questions
                    about my projects, experience, skills, and what I want to
                    build next.
                    <br /> Whether you&apos;re a recruiter, collaborator, or
                    just curious, ask directly instead of digging through a
                    static portfolio.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-accent-foreground text-base leading-relaxed">
                    Traditional portfolios are good at listing things but weak at
                    helping someone explore them.
                    <br /> This one adapts to what you care about: flagship
                    projects, resume highlights, GitHub work, or how I think
                    about applied AI.
                  </p>
                </div>
              </section>
            ...
            <div className="flex flex-col items-center px-8 pt-4 pb-0 md:pb-8">
              ...
              >
                <p className="text-muted-foreground">
                  Feedback is welcome. If something feels unclear, ask me in the
                  chat.
                </p>
